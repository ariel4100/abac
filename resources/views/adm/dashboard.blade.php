        ...
        <ul class="collapsible z-depth-0">
            <li class="bold">
                ...
                <div class="collapsible-body">
                    ...
                    <div><a href="{{route('newsletter')}}">Newsletter</a></div>
                </div>
            </li>
            ...
            <li class="bold">
                ...
                <div class="collapsible-body">
                        <div class=""><a href="{{route('contenido.index', ['seccion' => 'descargas', 'tipo' => 'imagen'])}}">Editar Descarga</a></div>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-admin"><i class="material-icons">account_circle</i>Zona Privada</a>
                <div class="collapsible-body">
                    <div class=""><a href="{{route('privadanivel.index')}}">Editar Nivel</a></div>
