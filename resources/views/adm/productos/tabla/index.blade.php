            ...
            <table class="responsive-table">
                ...
                <tbody>
                    <form action="{{ route('producto.tabla.store') }}" method="post">
                        ...
                        <tr>
                            <td class="center"><input type="text" name="a"></td>
                            <td class="center"><input type="text" name="b"></td>
                            <td class="center"><input type="text" name="c"></td>
                            <td class="center"><input type="text" name="d"></td>
                            <td class="center"><input type="text" name="e"></td>
                            <td class="center"><input type="text" name="f"></td>
        ...
        <div class="col s12">
            ...
            @foreach($tabla as $t)
                <form action="{{ route('producto.tabla.update',$t->id) }}" method="post">
                    ...
                    @method('PUT')
                    <tr>
                        <td><input type="text" name="a" value="{{ $t->a }}"></td>
                        <td><input type="text" name="b" value="{{ $t->b }}"></td>
