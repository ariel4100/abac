...
@section('content')
<div class="container">
    @include('page.partials.title', ['title' => 'Herramientas'])
    <div class="row mt50 mb70">
        ...
        <div class="col l6 m6 s12 mb30">
            ...
            ">
                ...
                <a class="waves-effect waves-light btn" href="{{ route($h->ruta) }}" style="background-color:#e1131b; margin-top: 30px">INGRESAR</a>
            </div>
        </div>
        @endforeach
    </div>
