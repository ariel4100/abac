...
Route::post('/contacto/trabaje-con-nosotros', 'ContactoController@storeContactoWork')->name('contactowork');
...
Route::group(['middleware' => 'auth', 'prefix' => 'privada', 'as' => 'privada'], function () {
    ...
    Route::get('/calidad', 'PrivadaController@calidadindex')->name('.calidad');
    ...
    Route::post('/calidad/solicitud/store', ['uses' => 'PrivadaController@solicitud', 'as' => '.solicitud.store']);
});
...
Route::group(['middleware' => 'auth:admin', 'prefix' => 'adm'], function () {
    ...
    Route::post('calculo/conexion', ['uses' => 'adm\CalculoController@conexionstore', 'as' => 'conexion.store']);
    Route::get('conexion/{id}/edit/', ['uses' => 'adm\CalculoController@conexionedit', 'as' => 'conexion.edit']);
    Route::put('conexion/update/{id}', ['uses' => 'adm\CalculoController@conexionupdate', 'as' => 'conexion.update']);
    ...
    //NEWSLETTER
    Route::get('newsletter', 'adm\NewsletterController@index')->name('newsletter');
    Route::get('newsletter/{id}', 'adm\NewsletterController@eliminar')->name('newsletter.eliminar');
    Route::post('newsletter/guardar', 'adm\NewsletterController@store')->name('newsletter.store');
    ...
    Route::group(['prefix' => 'privada', 'as' => 'privada'], function() {
        ...
        //Niveles de Clientes
        Route::resource('nivel', 'adm\NivelController');
        Route::get('nivel/eliminar/{id}', 'adm\NivelController@eliminar')->name('nivel.eliminar');
    });
...
Route::get('api/familia','adm\FamiliaController@apifamilia');
Route::post('api/resultado','adm\CalculoController@resultado');
Route::get('api/liquido','adm\CalculoController@liquido');
Route::get('api/gas','adm\CalculoController@gas');
Route::post('api/solofiltro','adm\CalculoController@solofiltro');
//buscador
Route::get('api/productos','FrontEndController@productos');
